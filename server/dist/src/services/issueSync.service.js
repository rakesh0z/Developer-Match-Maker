...
import { fetchIssues } from "./issue.service.js";
...
const parseRepoFromRepositoryUrl = (repository_url) => {
...
const deriveRepoIntId = (owner, name) => {
...
const deriveRepoStubs = () => {
    ...
    return { language: null, stars: 0, forks: 0 };
};
...
//# sourceMappingURL=issueSync.service.js.map